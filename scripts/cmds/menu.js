...
const doNotDelete = "[𝑲𝑰𝑵𝑮 𝑴𝑶𝑵𝑺𝑻𝑬𝑹𝑾𝑰𝑻𝑯𝑲𝑰𝑵𝑮 𝑴𝑶𝑵𝑺𝑻𝑬𝑹𝑾𝑰𝑻𝑯]\n               ";
const characters = "━━━━━━━━━━━━━━━";
/** 
* @author NTKhang
	...
	onStart: async function ({ message, args, event, threadsData, getLang, role }) {
		...
		if (!command && !args[0] || !isNaN(args[0])) {
			...
			if (sortHelp == "name") {
				...
				message.reply(getLang("menu", msg, characters, commands.size, prefix, doNotDelete));
			}
		}
